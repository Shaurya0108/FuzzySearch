...
namespace GameAI
{
...

    {
        ...
        {
            StartCoroutine(DeferredResetCar(trackResetCountAndPreserveDist));
        }

        protected IEnumerator DeferredResetCar(bool trackResetCountAndPreserveDist)
        {
            while(!pathTracker.PathInitialized)
            {
